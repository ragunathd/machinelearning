...
for ex = 1:m,
	...
	yt = y(ex,:);
	d3 = lay3t - yt;
	d2 = Theta2'*d3' .* sigmoidGradient([1;Theta1 * lay1t']);

	delta1 = delta1 + d2(2:end)*lay1t;
	delta2 = delta2 + d3' * lay2t;
end;
